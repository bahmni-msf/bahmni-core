...
public class CSVObservationHelper {
    ...
    void createObservations(List<EncounterTransaction.Observation> observations, Date encounterDate, KeyValue obsRow, List<String> conceptNames) throws ParseException {
    ...
    void verifyNumericConceptValue(KeyValue obsRow, List<String> conceptNames) {
