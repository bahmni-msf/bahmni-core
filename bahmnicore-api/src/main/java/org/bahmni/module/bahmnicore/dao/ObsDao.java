...
public interface ObsDao {
    ...
    List<Obs> getObsFor(String patientUuid, List<String> conceptNames, List<Integer> listOfEncounterIds, List<Integer> listOfVisitIds, Integer limit, ObsDaoImpl.OrderBy sortOrder, List<String> obsIgnoreList, Boolean filterOutOrderObs, Order order, Date startDate, Date endDate);
